...
const copy = {
  es: {
    ...
    servicesList: [
      ...
      ["Generadores y respaldo eléctrico", "/service"],
      ["Aire acondicionado", "/service"],
      ["Sistemas de seguridad", "/service"],
      ["Cámaras y videovigilancia", "/service"],
    ],
  },
  en: {
    home: "Home",
    ...
    servicesList: [
      ...
      ["Generators and backup power", "/service"],
      ["Air conditioning", "/service"],
      ["Security systems", "/service"],
      ["Cameras and surveillance", "/service"],
    ],
  },
};
