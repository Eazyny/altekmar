...
const copy = {
  es: {
    ...
    servicesList: [
      ...
      ["Generadores y respaldo eléctrico", "/services"],
      ["Aire acondicionado", "/services"],
      ["Sistemas de seguridad", "/services"],
      ["Cámaras y videovigilancia", "/services"],
    ],
  },
  en: {
    home: "Home",
    ...
    servicesList: [
      ...
      ["Generators and backup power", "/services"],
      ["Air conditioning", "/services"],
      ["Security systems", "/services"],
      ["Cameras and surveillance", "/services"],
    ],
  },
};
