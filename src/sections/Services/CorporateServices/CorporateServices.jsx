...
const hub = {
  es: {
    ...
    cards: [
      ...
      ["05", "Cámaras y videovigilancia", "Cobertura, grabación y monitoreo.", "/shop/cameras-surveillance"],
    ],
  },
  en: {
    ...
    cards: [
      ...
      ["05", "Cameras and surveillance", "Coverage, recording, and monitoring.", "/shop/cameras-surveillance"],
    ],
  },
};
