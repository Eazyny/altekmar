              ...
              <div className="row justify-content-between align-items-center">
                <div className="col-md">
                  <p className="woocommerce-result-count">
                    {text.showing} {products.length} {text.of}{" "}
                    {catalog.products.length} {text.elevators}
                  </p>
                </div>
            ...
            {products.length ? (
              <div className="row gy-40">
                {products.map((product) => {
                  ...
                  const title = localizedTitle(product, language);
          ...
          <div className="col-xl-3 col-lg-4">
            <aside className="sidebar-area">
              <div className="widget widget_search">
                <h3 className="widget_title">{text.searchTitle}</h3>
                <form
                ...
                >
                  ...
                  />
                  <button type="submit" aria-label={text.searchTitle}>
                    <i className="ri-search-line" />
                  </button>
                </form>
              </div>
              ...
              <div className="widget widget_tag_cloud">
                ...
                <div className="tagcloud">
                  <Link href="/service-details">{text.residential}</Link>
                  <Link href="/service-details">{text.commercial}</Link>
                  <Link href="/service-details">{text.accessibility}</Link>
                  <Link href="/service-details">{text.modernization}</Link>
                  <Link href="/contact">{text.installation}</Link>
                </div>
              </div>
            </aside>
          </div>
